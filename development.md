...
- Dosya, Vercel'in 4.5MB serverless limitine takılmamak için **client-side upload** yöntemiyle doğrudan tarayıcıdan Vercel Blob'a yüklenir (\`@vercel/blob/client\`).
